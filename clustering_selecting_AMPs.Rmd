...
selected_amp <- aa_comp_peptides1_names[which(x[["V1"]] >= -7 & x[["V1"]] <= -2 & x[["V2"]] >= -8 & x[["V2"]] <= 1.25 & aa_comp_peptides1_names == "AMP")]
knitr::kable(selected_amp)
```
...
selected_amp <- props_names[which(as.data.frame(tsne_aa_res1)[["V1"]] >= 40 & as.data.frame(tsne_aa_res1)[["V1"]] <= 85 & as.data.frame(tsne_aa_res1)[["V2"]] >= -35 & 
                                    as.data.frame(tsne_aa_res1)[["V2"]] <= 40 & props_names == "AMP")]
knitr::kable(selected_amp)
```
...
x <- as.data.frame(umap_res1[["layout"]])
selected_amp <- props_names[which(x[["V1"]] >= -4.5 & x[["V1"]] <= -1.75 & x[["V2"]] >= -5 & x[["V2"]] <= -2 & props_names == "AMP")]
knitr::kable(selected_amp)
```
