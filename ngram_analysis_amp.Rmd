...
if(length(frequent_for_all) > 0) {
  found_motifs_AMP <- locate_motifs(amp_datasets_list["DBAASP AMP max 100 aa"], frequent_for_all)
  plot_motif_position_density(amp_datasets_list, "DBAASP AMP max 100 aa",
                              found_motifs_AMP, density_col = colors3[["DBAASP AMP max 100 aa"]])
  
    found_motifs_cTPmTP <- locate_motifs(amp_datasets_list["cTP-mTP experimentally verified presequence"], frequent_for_all)
  plot_motif_position_density(amp_datasets_list, "cTP-mTP experimentally verified presequence",
                              found_motifs_cTPmTP, density_col = colors3[["cTP-mTP experimentally verified presequence"]])
  
  found_motifs_cTP <- locate_motifs(amp_datasets_list["cTP experimentally verified presequence"], frequent_for_all)
  plot_motif_position_density(amp_datasets_list, "cTP experimentally verified presequence",
                              found_motifs_cTP, density_col = colors3[["cTP experimentally verified presequence"]])
  
  found_motifs_mTP <- locate_motifs(amp_datasets_list["mTP experimentally verified presequence"], frequent_for_all)
  plot_motif_position_density(amp_datasets_list, "mTP experimentally verified presequence",
                              found_motifs_mTP, density_col = colors3[["mTP experimentally verified presequence"]])
  
  found_motifs_SP <- locate_motifs(amp_datasets_list["SP experimentally verified presequence"], frequent_for_all)
  plot_motif_position_density(amp_datasets_list, "SP experimentally verified presequence",
                              found_motifs_SP, density_col = colors3[["SP experimentally verified presequence"]])
