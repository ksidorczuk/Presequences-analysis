...
selected_combns <- get_statistical_analysis_aa_comp(aa_comp_peptides, list(c("AmyPro regions", "CPAD peptides"),
                                                                           ...
                                                                           c("cTP experimentally verified location", "dTP experimentally verified location"), 
                                                                           c("cTP experimentally verified location", "dTP experimentally verified presequence"),
                                                                           c("cTP experimentally verified presequence", "dTP experimentally verified location"), 
                                                                           c("cTP experimentally verified presequence", "dTP experimentally verified presequence"),
                                                                           c("dTP experimentally verified location", "dTP experimentally verified presequence"),
                                                                           c("dTP experimentally verified location", "mTP experimentally verified presequence"),
                                                                           c("dTP experimentally verified presequence", "mTP experimentally verified presequence"),
                                                                           c("dTP experimentally verified location", "mTP experimentally verified location"),
                                                                           c("dTP experimentally verified presequence", "mTP experimentally verified location"),
...
p <- ggbiplot(pca_props_res1, choices = 1:2, alpha = 0.25, ellipse = TRUE, groups = datasets) +
  ...
  facet_wrap(~groups, ncol = 4) + 
    xlim(-8, 12) +
    ylim(-12, 12)
ggsave(paste0(results_path, "PCA_props_grouped.png"), p, width = 15, height = 10)
```
