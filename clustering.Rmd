...
```{r}
aa_comp_peptides <- calculate_aa_comp_peptides(datasets_list)
...
selected_combns <- get_statistical_analysis_aa_comp(aa_comp_peptides, list(c("Amyloids combined", "AmyPro regions"), 
                                                                           c("Amyloids combined", "CPAD peptides"),
                                                                           c("AmyPro regions", "CPAD peptides"),
