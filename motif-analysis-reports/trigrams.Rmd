...
trigram_freqs <- calculate_ngram_freq(filtered_datasets_list, 3, 0)
...
## Detailed analysis of presequences
```{r}
trigram_fracs <- calculate_ngram_fractions(presequence_datasets_list, 3, 0)
...
binary_trigrams <- lapply(names(presequence_datasets_list), function(ith_dataset) {
  calculate_binary_ngram_matrix(presequence_datasets_list[[ith_dataset]], 3, 0) %>%
...
save(test_res, file = "trigrams_test_res.rda")
