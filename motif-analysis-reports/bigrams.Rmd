...
bigram_plot_dat_presequences <- bigram_plot_dat %>% 
  filter(dataset %in% c("cTP-mTP experimentally verified presequence", "cTP experimentally verified presequence", 
                        "mTP experimentally verified presequence", "SP experimentally verified presequence"))
plot_motif_venn_diagram(bigram_plot_dat_presequences, colors2)
```
...
cTP vs. mTP
```{r}
x <- select_quipt_informative_motifs(binary_bigrams,
                                     "cTP experimentally verified presequence",
                                     "mTP experimentally verified presequence")
...
cTP vs. mTP
```{r}
y <- select_fcbf_informative_motifs(binary_bigrams,
                                    "cTP experimentally verified presequence",
                                    "mTP experimentally verified presequence")
...
```{r fig.height = 20}
test_res <- do_statistical_analysis(binary_bigrams)
